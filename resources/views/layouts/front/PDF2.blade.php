    ...
    <section id="faq" class="faq section-padding" style="margin-top:5rem; background:#e6e6e6;">
      <div class="container" data-aos="fade-up">
        ...
        <ul class="faq-list" data-aos="fade-up">
          <li>
              <a data-toggle="collapse" class="collapsed" href="#faq1">@lang('front.Executive Director Appointment Regulations')<span class="icon-show lnr lnr-chevron-left"></span><span class="icon-close lnr lnr-chevron-down"></span></a>
