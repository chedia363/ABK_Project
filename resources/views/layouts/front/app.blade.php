        ...
        <div class="col-xl-4 col-md-4">
          <div class="searchmobile" style="display:flex;">
            ...
            <div class="search-box">
              <form style="width:100%; display:flex;" id="f1" name="f1" action="javascript:void()" onsubmit="if(this.t1.value!=null && this.t1.value!='')parent.findString(this.t1.value);return false;">
                <button name="b1" class="search-btn"><span class="lnr lnr-magnifier"></span></button>
                <input id="t1" name="t1" class="search-input" type="text" placeholder="@lang('front.Search')">
              </form>
            </div>
          </div>
        </div>
